...
```typescript
import { Sw4p } from '@sw4p/sdk'

const bridge = new Sw4p({ 
  apiKey: 'sk_...',
  debug: true
})
```
...
```typescript
import { ApiError, AuthError, RateLimitError } from '@sw4p/sdk'
...
<CardGroup cols={2}>
  <Card title="npm" icon="npm" href="https://www.npmjs.com/package/@sw4p/sdk">
    View on npm
  </Card>
